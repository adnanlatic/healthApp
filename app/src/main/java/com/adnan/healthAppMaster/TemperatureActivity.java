...
public class TemperatureActivity extends AppCompatActivity {
    ...
    private TextView izmjerenaTemperature;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(TemperatureActivity.this, MainActivity.class);
                startActivity(i);
            }
        });
        getDataFromDatabase();
    ...
    private void drawLineChart() {
        LineChart lineChart = findViewById(R.id.lineChartTemp);
        lineChart.setDragEnabled(true);
        lineChart.setScaleEnabled(true);
        List<Entry> lineEntries = getDataSet();
        LineDataSet lineDataSet = new LineDataSet(lineEntries, "Temperatura");
